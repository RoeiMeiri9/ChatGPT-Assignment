...
export class ChatBoardComponent {
  ...
  constructor(private api: APIService, private cdr: ChangeDetectorRef, private httpClient: HttpClient) {
    this.api.test()
    this.httpClient.get('http://localhost:3200/').subscribe((restult) => (console.log(restult)));
  }
